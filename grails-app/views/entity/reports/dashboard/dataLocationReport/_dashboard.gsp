...
<img src="${resource(dir:'images',file:'list-spinner.gif')}" class="ajax-big-spinner"/>
		...
		<div class="v-tabs-content right">
					...
					>
						...
						<li class="v-tabs-row">
							<p>
								...
								<span class="v-tabs-value"> <g:formatNumber
										number="${totalCorectiveMarks}"
										type="number"
										maxFractionDigits="2"
										...
										>
											...
											>
												<li class="v-tabs-row"><span class="v-tabs-name">
													...
													</g:if> <span class="v-tabs-value"> <g:formatNumber
															number="${indicatorValue?.computedValue}"
															type="number"
															maxFractionDigits="2"
															minFractionDigits="2"
															minIntegerDigits="1"
			...
			<div id="preventive">
				<ul class="v-tabs-list">
					<!--initialise for priventive marking -->
					<g:each
