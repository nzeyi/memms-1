...
<img src="${resource(dir:'images',file:'list-spinner.gif')}" class="ajax-big-spinner"/>
    ...
    <ul id='top_tabs' class="v-tabs-nav left">
      ...
      <li><a id="#equipment" class="" href="${createLinkWithTargetURI(controller: 'account', action:'editAccount')}">Management Medical Equipment</a></li>
    ...
    <div class="v-tabs-content right">
     <a id="showhide" class="right" href="#">Show / Hide filters</a>
      ...
      <div class="filters main">
        ...
        <script src="/memms/static/js/dashboard/aggregation/ajaxLoadingScrpt.js.js" type="text/javascript" ></script>
						...
						>
							...
							>
								<li class="v-tabs-row"><span class="v-tabs-name">
										${indicatorValue?.indicator?.names}</span> <span class="v-tabs-formula">${indicatorValue?.indicator?.formula}</span> <span
									class="v-tabs-value"
